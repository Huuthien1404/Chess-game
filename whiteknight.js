function handleClickWhiteKnight() {
    ...
    if (event.currentTarget.style.backgroundColor == "") {
      ...
      if (currentPositionByLeft >= 0 && currentPositionByLeft + 25 <= 87.5 && currentPositionByBottom >= 0 && currentPositionByBottom + 12.5 <= 87.5) {
        for (var i = 0; i < listBox.length; i++) {
            if (parseFloat(listBox[i].style.left) == currentPositionByLeft + 25 && parseFloat(listBox[i].style.bottom) == currentPositionByBottom + 12.5) {
                var checkBlackAppear = false;
                var checkWhiteAppear = false;
                for (var j = 0; j < listBlackSoldier.length; j++) {
                    if (parseFloat(listBlackSoldier[j].style.left) == parseFloat(listBox[i].style.left) && parseFloat(listBlackSoldier[j].style.bottom) == parseFloat(listBox[i].style.bottom)) {
                ...
                if (checkBlackAppear == true) {
                    ...
                    for (var j = 0; j < listWhiteSoldier.length; j++) {
                        if (parseFloat(listWhiteSoldier[j].style.left) == parseFloat(listBox[i].style.left) && parseFloat(listWhiteSoldier[j].style.bottom) == parseFloat(listBox[i].style.bottom)) {
      ...
      if (currentPositionByLeft >= 0 && currentPositionByLeft + 12.5 <= 87.5 && currentPositionByBottom >=0 && currentPositionByBottom + 25 <= 87.5) {
        for (var i = 0; i < listBox.length; i++) {
            if (parseFloat(listBox[i].style.left) == currentPositionByLeft + 12.5 && parseFloat(listBox[i].style.bottom) == currentPositionByBottom + 25) {
                var checkBlackAppear = false;
                var checkWhiteAppear = false;
                for (var j = 0; j < listBlackSoldier.length; j++) {
                    if (parseFloat(listBlackSoldier[j].style.left) == parseFloat(listBox[i].style.left) && parseFloat(listBlackSoldier[j].style.bottom) == parseFloat(listBox[i].style.bottom)) {
