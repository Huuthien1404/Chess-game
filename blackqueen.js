function handleClickBlackQueen() {
  ...
  if (event.currentTarget.style.backgroundColor == "green") {
    ...
    if (event.currentTarget.style.backgroundColor == "") {
      ...
      for (var i = 12.5; i <= 87.5; i += 12.5) {
        if (currentPositionByLeft >= 0 && currentPositionByLeft + i <= 87.5) {
            ...
            if (
              ...
              for (var k = 0; k < listWhiteSoldier.length; k++) {
                if (
                  ...
                  listWhiteSoldier[k].style.backgroundColor = "green";
                  listWhiteSoldier[k].style.pointerEvents = "auto";
                  listWhiteSoldier[k].style.border = "2px solid black";
                  break;
                }
              }
      ...
      for (var i = 12.5; i <= 87.5; i += 12.5) {
        if (
          ...
          currentPositionByBottom + i <= 87.5
        ) {
          var checkBlackAppear = false;
          var checkWhiteAppear = false;
          for (var j = 0; j < listBox.length; j++) {
      ...
      for (var i = 12.5; i <= 87.5; i += 12.5) {
        ...
        if (
          ...
          currentPositionByBottom >= 0 &&
          currentPositionByLeft + i <= 87.5 &&
          currentPositionByBottom + i <= 87.5
        ) {
          for (var j = 0; j < listBox.length; j++) {
            if (
              parseFloat(listBox[j].style.left) == currentPositionByLeft + i &&
              parseFloat(listBox[j].style.bottom) == currentPositionByBottom + i
            ) {
              for (var k = 0; k < listWhiteSoldier.length; k++) {
                if (
                  parseFloat(listWhiteSoldier[k].style.left) ==
